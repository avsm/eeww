...
module Private = struct
  ...
  module Raw_grammar = struct
    ...
    module Builtin = struct
      ...
      let ref_sexp_grammar = Inline (Tyvar_parameterize ([ "'a" ], Tyvar_index 0))
      let lazy_t_sexp_grammar = Inline (Tyvar_parameterize ([ "'a" ], Tyvar_index 0))
    ...
    let tuple2_sexp_grammar =
      Inline
        (Tyvar_parameterize
           ([ "'a"; "'b" ], List [ One (Tyvar_index 0); One (Tyvar_index 1) ]))
    ;;
  end
end
