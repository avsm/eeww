...
(* OASIS_START *)
(* DO NOT EDIT (digest: aab28a76eb3906a87dbe3a8d00c0855e) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "mirage-flow";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "cþ\132\021oGT\143\156Ý}\004C\154ã$";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
