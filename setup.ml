...
(* OASIS_START *)
(* DO NOT EDIT (digest: 46a1cf943f625c027344393750c81ad9) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/mirage/ocaml-magic-mime";
          ...
          conf_custom =
            {
               ...
               post_command =
                 [(OASISExpr.EBool true, Some (("sh", ["./generate.sh"])))]
            };
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Magic_mime"; "Mime_types"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "magic-mime";
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      ...
                      src_repo_browser =
                        Some "https://github.com/mirage/ocaml-magic-mime";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\127³JÁ\140\017éDO\"¬ÿj¬°\018";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
