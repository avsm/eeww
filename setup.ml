...
(* OASIS_START *)
(* DO NOT EDIT (digest: 83c629858f87bd981f146351a6cd2d59) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                      ...
                      },
                   {
                      ...
                      lib_findlib_name = Some "ocp-read";
               ...
               SrcRepo
                 ({
                     ...
                     },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/chambart/ocp_read.git";
                      src_repo_browser =
                        Some "https://github.com/chambart/ocp_read";
     ...
     oasis_digest = Some "\131\251\1773$\128\031\241\t\011Hu\214G\019\224";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
