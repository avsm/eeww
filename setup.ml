...
(* OASIS_START *)
(* DO NOT EDIT (digest: aa28c942d041c95fe2388bf3ba3fc36c) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_stringext", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("test_stringext_qcheck",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_stringext_qcheck", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_stringext.ml"});
               Executable
                 ({
                     cs_name = "test_stringext_qcheck";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("qcheck.ounit", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "test_stringext_qcheck.ml"
                   })
            ];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "±ø\129d\149\136g¸Ù\134§\135íe\026|";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
