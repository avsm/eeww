...
(* OASIS_START *)
(* DO NOT EDIT (digest: 00bbec8aecd191f60f17c5894c5368a7) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "otunctl.ml"});
               Executable
                 ({
                     cs_name = "sendfd_test";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "sendfd_test.ml"});
               Executable
                 ({
                     cs_name = "nonblock_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "nonblock_test.ml"});
               Executable
                 ({
                     cs_name = "nonblock_read";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "nonblock_read.ml"});
               Executable
                 ({
                     cs_name = "getifaddrs_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "getifaddrs_test.ml"});
               Executable
                 ({
                     cs_name = "set_ipv4_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "set_ipv4_test.ml"});
               Executable
                 ({
                     cs_name = "open_close_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "open_close_test.ml"});
               Doc
                 ({
                     cs_name = "api";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\155}\1670\014\139\185\16927\230\238\255`\1870";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
