...
(* OASIS_START *)
(* DO NOT EDIT (digest: f5abc5ac061bd89ec288561e26aa3c40) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, ["-g"; "-ggdb"])];
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "\238r`\030\029M\197\223\018\185\000\180\185\215@F";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
