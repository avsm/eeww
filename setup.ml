...
(* OASIS_START *)
(* DO NOT EDIT (digest: d8069a6687360bd7e9793d5d4e50287c) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/hannesm/ocaml-hkdf";
          synopsis =
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "rfctests.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\181\011%o\002\191\251}\023G\235\154\030\227b!";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
